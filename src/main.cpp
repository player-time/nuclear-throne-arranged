...
float fps_samples[30];
int fps_samples_idx = 0;
...
void draw_weapon_text(int wep_ID, sf::Vector2f pos, sf::Text text, sf::RenderTexture& renderer, sf::Sprite wep_arrow_sprite) {
    switch (wep_ID) {
    default:text.setString("NONE");break;
    case 0:text.setString("ULTRA SHOVEL");break;
    case 1:text.setString("CHICKEN SWORD");break;
    case 2:text.setString("BLACK SWORD");break;
    case 3:text.setString("WRENCH");break;
    ...
    case 18:text.setString("LASER PISTOL");break;
    case 19:text.setString("LASER RIFLE");break;
    case 20:text.setString("LASER MINIGUN");break;
    ...
    case 64:text.setString("SEEKER PISTOL");break;
    case 65:text.setString("SEEKER SHOTGUN");break;
    ...
    case 84:text.setString("SHOTGUN"); break;
    ...
    renderer.draw(wep_arrow_sprite);
    draw_text_NT(text, renderer);
}

sound_ID get_shoot_sound(int wep_id) {
    switch (wep_id) {
    ...
    case 8: /*Esword*/
        if (laser_brain < 1.15f) {
            return snd_energy_sword_ID;
        }
        else {
            return snd_energy_sword_up_ID;
        }
        break;

    case 9: /*Ehammer*/
        if (laser_brain < 1.15f) {
            return snd_energy_hammer_ID;
        }
        else {
            return snd_energy_hammer_up_ID;
        }
        break;

    case 10: /*Escrew*/
        if (laser_brain < 1.15f) {
            return snd_energy_screw_ID;
        }
        else {
            return snd_energy_screw_up_ID;
        }
        break;
    ...
    case 12: /*PC*/
        ...
        else {return snd_plasma_cannon_up_ID;}
        break;
    case 13: /*plasma gun*/
        if (laser_brain < 1.15f) {return snd_plasma_gun_ID;}
        else {return snd_plasma_gun_up_ID;}
        break;
    case 14: /*plasma rifle*/
        if (laser_brain < 1.15f) {return snd_plasma_rifle_ID;}
        else {return snd_plasma_rifle_up_ID;}
        break;
    case 15: /*plasma mini*/
        if (laser_brain < 1.15f) {return snd_plasma_mini_ID;}
        else {return snd_plasma_mini_up_ID;}
        break;
    case 16: /*gold plasma gun*/
        if (laser_brain < 1.15f) {return snd_gold_plasma_gun_ID;}
        else {return snd_gold_plasma_gun_up_ID;}
        break;
    case 17: /*devastator*/
        if (laser_brain < 1.15f) {return snd_devastator_ID;}
        else {return snd_devastator_up_ID;}
        break;
    case 18: /*laser pistol*/
        if (laser_brain < 1.15f) { return snd_laser_ID; }
        else { return snd_laser_up_ID; }
        break;
    case 19: /*laser rifle*/
        if (laser_brain < 1.15f) { return snd_laser_ID; }
        else { return snd_laser_up_ID; }
        break;
    case 20: /*laser minigun*/
        if (laser_brain < 1.15f) { return snd_laser_ID; }
        else { return snd_laser_up_ID; }
        break;
    case 21: /*golden laser pistol*/
        if (laser_brain < 1.15f) { return snd_golden_laser_ID; }
        else { return snd_golden_laser_up_ID; }
        break;
    case 22: /*ultra laser pistol*/
        if (laser_brain < 1.15f) { return snd_ultra_laser_ID; }
        else { return snd_ultra_laser_up_ID; }
        break;
    ...
    case 30: /*golden revolver*/return snd_gold_revolver_ID;break;
    case 31: /*rogue rifle*/return snd_rogue_rifle_ID;break;
    case 32: /*rusty revolver*/return snd_rusty_revolver_ID;break;
    case 33: /*assault rifle*/return snd_machinegun_ID;break;
    case 34: /*machinegun*/return snd_machinegun_ID;break;
    case 35: /*SMG*/return snd_revolver_ID;break;
    case 36: /*triple machinegun*/return snd_triple_machinegun_ID;break;
    case 37: /*minigun*/return snd_minigun_ID;break;
    case 38: /*hyper rifle*/return snd_hyper_rifle_ID;break;
    case 39: /*smart gun*/return snd_smart_gun_ID;break;
    case 40: /*quadruple machinegun*/return snd_quadruple_machinegun_ID;break;
    case 41: /*double minigun*/return snd_double_minigun_ID;break;
    case 42: /*gold machinegun*/return snd_gold_machinegun_ID;break;
    case 43: /*gold assault rifle*/return snd_gold_machinegun_ID;break;
    case 44: /*heavy revolver*/return snd_heavy_revolver_ID; break;
    case 45: /*heavy machine gun*/return snd_heavy_machinegun_ID;break;
    case 46: /*heavy assault rifle*/return snd_heavy_machinegun_ID;break;
    case 47: /*bouncer SMG*/return snd_bouncer_SMG_ID;break;
    ...
    case 66: /*Auto Shotgun*/return snd_shotgun_ID;break;
    ...
    case 73: /*Auto Flame Shotgun*/return snd_flame_shotgun_ID;break;
    case 74: /*Slugger*/return snd_slugger_ID;break;
    case 75: /*Assault Slugger*/return snd_slugger_ID;break;
    case 76: /*Gatling Slugger*/return snd_slugger_ID;break;
    case 77: /*Super Slugger*/return snd_super_slugger_ID;break;
    case 78: /*Golden Slugger*/return snd_gold_slugger_ID;break;
...
sf::Vector2f wep_get_origin(int wep_id) {
    switch (wep_id) {
    case 0: /*ushov*/return sf::Vector2f(5, 7); break;
    case 1: /*sword*/return sf::Vector2f(5, 4); break;
    ...
    case 11: /*SPC*/ return sf::Vector2f(3, 6); break;
    case 12: /*PC*/ return sf::Vector2f(5, 5); break;
    ...
    case 18: /*laser pistol*/return sf::Vector2f(-3, 3);break;
    case 19: /*laser rifle*/return sf::Vector2f(6, 6);break;
    case 20: /*laser minigun*/return sf::Vector2f(5, 7);break;
    ...
    case 30: /*golden revolver*/return sf::Vector2f(-2, 3); break;
    case 31: /*rogue rifle*/return sf::Vector2f(3, 4); break;
    case 32: /*rusty revolver*/return sf::Vector2f(-2, 3); break;
    case 33: /*assault rifle*/return sf::Vector2f(5, 4); break;
    case 34: /*machinegun*/return sf::Vector2f(2, 2); break;
    case 35: /*SMG*/return sf::Vector2f(3, 4); break;
    case 36: /*triple machinegun*/return sf::Vector2f(0, 5); break;
    case 37: /*minigun*/return sf::Vector2f(3, 4); break;
    case 38: /*hyper rifle*/return sf::Vector2f(7, 10); break;
    case 39: /*smart gun*/return sf::Vector2f(7, 6); break;
    case 40: /*quadruple machinegun*/return sf::Vector2f(5, 5); break;
    case 41: /*double minigun*/return sf::Vector2f(3, 7); break;
    case 42: /*gold machinegun*/return sf::Vector2f(2, 2); break;
    case 43: /*gold assault rifle*/return sf::Vector2f(5, 4); break;
    case 44: /*heavy revolver*/return sf::Vector2f(0, 4); break;
    case 45: /*heavy machine gun*/return sf::Vector2f(4, 4); break;
    case 46: /*heavy assault rifle*/return sf::Vector2f(4, 5); break;
    case 47: /*bouncer SMG*/return sf::Vector2f(4, 4); break;
    ...
    case 64: /*seeker pistol*/return sf::Vector2f(2, 2); break;
    case 65: /*seeker shotgun*/return sf::Vector2f(2, 3); break;

    case 84: /*shotgun*/return sf::Vector2f(4, 3); break;
    case 85: /*double shotgun*/return sf::Vector2f(4, 3); break;
...
void play_swap_sound(int wep_id) {
    switch (wep_id) {
    case 0: /*ushov*/play_sounds_this_frame_count[snd_hammer_swap_ID] = 1; break;
    case 1: /*sword*/play_sounds_this_frame_count[snd_sword_swap_ID] = 1; break;
    case 2: /*black sword*/play_sounds_this_frame_count[snd_sword_swap_ID] = 1; break;
    case 3: /*wrench*/play_sounds_this_frame_count[snd_hammer_swap_ID] = 1; break;
    ...
    case 11:  /*SPC*/play_sounds_this_frame_count[snd_energy_swap_ID] = 1; break;
    case 12:  /*PC*/play_sounds_this_frame_count[snd_energy_swap_ID] = 1; break;
    ...
    case 18: /*laser pistol*/play_sounds_this_frame_count[snd_energy_swap_ID] = 1; break;
    case 19: /*laser rifle*/play_sounds_this_frame_count[snd_energy_swap_ID] = 1; break;
    case 20: /*laser minigun*/play_sounds_this_frame_count[snd_energy_swap_ID] = 1; break;
    ...
    case 30: /*golden revolver*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 31: /*rogue rifle*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 32: /*rusty revolver*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 33: /*assault rifle*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 34: /*machinegun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 35: /*SMG*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 36: /*triple machinegun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 37: /*minigun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 38: /*hyper rifle*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 39: /*smart gun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 40: /*quadruple machinegun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 41: /*double minigun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 42: /*gold machinegun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 43: /*gold assault rifle*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 44: /*heavy revolver*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 45: /*heavy machine gun*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 46: /*heavy assault rifle*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    case 47: /*bouncer SMG*/play_sounds_this_frame_count[snd_pistol_swap_ID] = 1; break;
    ...
    case 64: /*seeker pistol*/play_sounds_this_frame_count[snd_bow_swap_ID] = 1; break;
    case 65: /*seeker shotgun*/play_sounds_this_frame_count[snd_bow_swap_ID] = 1; break;

    case 84: /*shotgun*/play_sounds_this_frame_count[snd_shotgun_swap_ID] = 1; break;
    case 85: /*double shotgun*/play_sounds_this_frame_count[snd_shotgun_swap_ID] = 1; break;
...
void pickup_ammo() {
    ...
    else if (wep_choice < energy_weps) {    //energy weapons
        player_energy += 10 + (player_character == fish) * 3;
        if (player_energy > player_energy_max) {
            player_energy = player_energy_max;
            create_popuptext("MAX ENERGY", allObjects[0].position + sf::Vector2f{ 0, -8 });
    ...
    else if (wep_choice < bullet_weps) {    //bullet weapons
        player_bullets += 32 + (player_character == fish) * 8;
        if (player_bullets > player_bullets_max) {
            player_bullets = player_bullets_max;
            create_popuptext("MAX BULLETS", allObjects[0].position + sf::Vector2f{ 0, -8 });
    ...
    else if (wep_choice < bolt_weps) {    //bullet weapons
        player_bolts += 7 + (player_character == fish) * 2;
        if (player_bolts > player_bolts) {
            player_bolts = player_bolts;
            create_popuptext("MAX BOLTS", allObjects[0].position + sf::Vector2f{ 0, -8 });
        }
        else {
            if (player_character == fish) {
    ...
    else if (wep_choice < shell_weps) {//shell weapons
        player_shells += 8 + (player_character == fish) * 2;
        if (player_shells > player_shells_max) {
            player_shells = player_shells_max;
            create_popuptext("MAX SHELLS", allObjects[0].position + sf::Vector2f{ 0, -8 });
    ...
    else if (wep_choice < explosive_weps) {//explosive weapons
        player_explosives += 6 + (player_character == fish) * 2;
        if (player_explosives > player_explosives_max) {
            player_explosives = player_explosives_max;
            create_popuptext("MAX EXPLOSIVES", allObjects[0].position + sf::Vector2f{ 0, -8 });
...
void calculate_ammo_drop_mult() {
    ...
    if (wep < melee_weps) { //melee
        ...
        if (player_bullets < player_bullets_max * 0.2f) {
            global_ammo_mult += 0.8f;
        }
        else if (player_bullets < player_bullets_max * 0.6f) {
            global_ammo_mult += 0.5f;
        }
        else {
            global_ammo_mult += 0.15f;
        ...
        if (player_bolts < player_bolts_max * 0.2f) {
            global_ammo_mult += 0.8f;
        }
        else if (player_bolts < player_bolts_max * 0.6f) {
            global_ammo_mult += 0.5f;
        }
        else {
            global_ammo_mult += 0.15f;
        ...
        if (player_shells < player_shells_max * 0.2f) {
            global_ammo_mult += 0.8f;
        }
        else if (player_shells < player_shells_max * 0.6f) {
            global_ammo_mult += 0.5f;
        }
        else {
            global_ammo_mult += 0.15f;
        ...
        if (player_explosives < player_explosives_max * 0.2f) {
            global_ammo_mult += 0.8f;
        }
        else if (player_explosives < player_explosives_max * 0.6f) {
            global_ammo_mult += 0.5f;
        }
        else {
            global_ammo_mult += 0.15f;
...
void make_T2_arena() {
    ...
    for (int i = left_physics + 3; i < right_physics - 3; i++) {
        for (int j = top_physics + 3; j < bottom_physics - 3; j++) {
            if (game_area[i][j].my_grid_type == T2_boarder) {
    ...
    for (int i = current_create_start; i < max_objects; i++) {
        if (allObjects[i].my_id == nothing) {
            ...
            case T2_bullet:
                ...
                break;
            case rogue_bullet:
                allObjects[i].my_id = idpd_bullet;
                allObjects[i].my_hitbox = enemy_bullet_hitbox;
                allObjects[i].damage = 3;
            ...
            case devastator_bullet:
                allObjects[i].my_id = obj_id;
                allObjects[i].my_hitbox = devastator_hitbox;
            ...
            case player_laser:
                ...
                allObjects[i].size = 0; //how many units the lasers length is

                allObjects[i].scale = laser_brain * laser_brain * 1.4f; //close to orginal game logic whith room for different values of laser_brain
            ...
            case player_lightning:
                ...
                allObjects[i].rotation = yspd;

                allObjects[i].scale = xspd;
            ...
            case player_shell_burst:
                ...
                if (image_index == 1) {
                    ...
                    allObjects[i].size = 3; //number of bullets
                    allObjects[i].alarm1 = 3;   //delay between shots
                }
                if (image_index == 2) {
                    allObjects[i].damage = 3;   //wave
                    allObjects[i].size = 10; //number of bullets
                    allObjects[i].alarm1 = 1;   //delay between shots
                }
            ...
            case player_bullet_burst:
                ...
                if (image_index == 1) {
                    allObjects[i].damage = 3;   //normal
                    allObjects[i].size = 3; //number of bullets
                    allObjects[i].alarm1 = 2;   //delay between shots
                    allObjects[i].alarm2 = 0;
                }
                if (image_index == 2) {
                    allObjects[i].damage = 3;   //normal
                    allObjects[i].size = 5; //number of bullets
                    allObjects[i].alarm1 = 1;   //delay between shots
                    allObjects[i].alarm2 = 0;
                }
                if (image_index == 3) {
                ...
                if (image_index == 4) {
                    ...
                    allObjects[i].size = 3; //number of bullets
                    allObjects[i].alarm1 = 2;   //delay between shots
                    allObjects[i].alarm2 = 1;   //gold sound
                }
                if (image_index == 5) {
                    allObjects[i].damage = 3;   //rogue
                    allObjects[i].size = 2; //number of bullets
                    allObjects[i].alarm1 = 3;   //delay between shots
                    allObjects[i].alarm2 = 2;   //rogue
                }
            ...
            case player_bolt:
                allObjects[i].my_id = obj_id;
                allObjects[i].my_hitbox = enemy_bullet_hitbox;
                allObjects[i].damage = 20;

                if (image_index == 1) {
                    allObjects[i].damage = 50;   //heavy
                }

                if (image_index == 2) {
                    allObjects[i].damage = 45;   //ultra
                    allObjects[i].alarm2 = 3;
                }

                if (image_index == 3) {
                    allObjects[i].damage = 4;   //spliter
                }

                if (image_index == 4) {
                    allObjects[i].damage = 16;   //toxic
                }

                if (image_index == 5) {
                    allObjects[i].damage = 21;   //gold
                }

                if (image_index == 6) {
                    allObjects[i].damage = 9;   //seeker
                }
                ...
                allObjects[i].image_index = 0;
                allObjects[i].team = player_team;     //player team'
                allObjects[i].alarm3 = 0;//whether it should disappear next frame
            ...
            case nade:
                ...
                allObjects[i].corpse_id = 0;// what enemy it sticks to if it does
                ...
                if (image_index == 1) {         //small explosion
                    allObjects[i].damage = 3;
                    allObjects[i].alarm1 = 70 + rand() % 10;
                }
                else if (image_index == 2) {    //green explosion
                    allObjects[i].damage = 30;
                }
                else if (image_index == 3) {    //cluster
                    allObjects[i].damage = 10;
                }
                else if (image_index == 4) {    //missile
                    allObjects[i].damage = 20;
                    allObjects[i].friction = -1.0f;
                }
                ...
                else if (image_index == 7) {    //blood ball
                    allObjects[i].friction = 0.02f;
                    allObjects[i].alarm1 = -210;
                    allObjects[i].damage = 45;
                }
                else if (image_index == 8) {    //flare
                    allObjects[i].alarm1 = 60;
                    allObjects[i].damage = 13;
                }
                else if (image_index == 9) {    //flame ball
...
void object_bounce_wall(int O, int h, int w, int width, int height, int i, int j) {
    ...
    w = int(allObjects[O].position.x / 16.0f) - i;
    h = int(allObjects[O].position.y / 16.0f) - j;
    ...
    else if (abs(diffx) < 8 + width && abs(diffy) < 8 + height) {
        if (diffx >= 0 && diffy >= 0) {
            if (diffx > diffy) {
                allObjects[O].position.x = (i * 16) + 16 + width;
            }
...
void player_shell_hyper_create(int obj) {
    bool collided = false;
    float X_prev = 0;
    float Y_prev = 0;
...
void player_lightning_create(sf::Vector2f position, float direction, int length) {
    float length_lightning = 4.0f;

    int nearest_enemy_id = 0;

    nearest_enemy_id = find_nearest_LOS_enemy(position);
    ...
    for (int i = 0; i < length; i++) {
        ...
        position += {cos(direction)* length_lightning,
            sin(direction)* length_lightning};

        if (game_area[int(position.x / 16)][int(position.y / 16)].my_grid_type == wall) {
            direction -= 180.0f / degreestoradians;
        }


        if (nearest_enemy_id != 0) {
            int end = atan2f(allObjects[nearest_enemy_id].position.y - position.y, allObjects[nearest_enemy_id].position.x - position.x) * degreestoradians;
            int start = direction * degreestoradians;
            float shortest_angle = ((((end - start) % 360) + 540) % 360) - 180;

            if (shortest_angle > 0) {
                direction += 8 / degreestoradians;
            }
            else {
                direction -= 8 / degreestoradians;
            }
...
void destroy_projectile(int object_index) {
    ...
    case player_lightning_orb:
        ...
        play_sound_relative_to_player(snd_lightning_orb_explo_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
        for (int I = 0; I < 9; I++) {
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, player_lightning_spawn, random_360_radians(), 14);
        }
        break;
    case devastator_bullet:
        allObjects[object_index].my_id = nothing;
        ...
        break;
    case player_bolt:
        allObjects[object_index].alarm3 = 1;    //turn into a on hit effect
    ...
    case player_shell:
        ...
        if (allObjects[object_index].size == 1) {   //flame
            ...
            allObjects[object_index].position.x -= allObjects[object_index].speed.x;
            allObjects[object_index].position.y -= allObjects[object_index].speed.y;

            allObjects[object_index].speed.x *= 0.5f;
            allObjects[object_index].speed.y *= 0.5f;
            ...
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, player_bullet_destroy, random_360_degrees(), 0);
        }
        else {
    ...
    case nade:      //NOW
        ...
        switch (allObjects[object_index].alarm3) {
        case 0:case 12://normal/gold
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, explosion, 0, 0);
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, flame, 0, 0);
            play_sound_relative_to_player(snd_explosion_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 1://mini
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, explosion, 0, 1);
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, flame, 0, 0);
            play_sound_relative_to_player(snd_explosion_s_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 2://heavy nade
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, explosion, 0, 2);
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, flame, 0, 0);
            play_sound_relative_to_player(snd_explosion_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 3://cluster nade
            for (int i = 0; i < 8; i++) {
                int id_to_move = create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 3.0f + random_float(5.0f), 0, nade, random_360_radians(), 1);
                motion_add_dir(allObjects[object_index].direction, 2.0f, id_to_move);
            }
            for (int i = 0; i < 8; i++) {
                tmpspd = random_float(3.0f);
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, tmpspd, tmpspd, smoke, 0, 0);    //smoke
            }
            play_sound_relative_to_player(snd_cluster_open_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 6://blood nade
            tmpdir = random_360_radians();
            for (int i = 0; i < 3; i++) {
                //meat
                tmpspdX = cos(tmpdir) * 24;
                tmpspdY = sin(tmpdir) * 24;
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, meat_explosion, 0, player_team);
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, tmpspdX / 10, tmpspdY / 10, static_effect, tmpdir * degreestoradians, 216);
                tmpdir += 120 / degreestoradians;
            }
            play_sound_relative_to_player(snd_blood_launcher_explode_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 7://blood ball
            tmpdir = random_360_radians();
            for (int i = 0; i < 6; i++) {
                ...
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, meat_explosion, 0, player_team);
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, tmpspdX / 10, tmpspdY / 10, static_effect, tmpdir * degreestoradians, 216);
                tmpdir += 60 / degreestoradians;
            }
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, portal_clear, 0, 0);
            play_sound_relative_to_player(snd_blood_cannon_end_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 8://flare
            allObjects[object_index].position -= allObjects[object_index].speed;
            for (int i = 0; i < 20; i++) {
                //player_flame
                tmpdir = random_360_radians();
                tmpspd = 1.0f + random_float(4.5f);
                tmpspdX = cos(tmpdir) * tmpspd;
                tmpspdY = sin(tmpdir) * tmpspd;
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, tmpspdX, tmpspdY, player_flame, tmpdir, 0);
            }
            play_sound_relative_to_player(snd_flare_explode_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 9://flame ball
            for (int i = 0; i < 20; i++) {
                //player_flame
                tmpdir = random_360_radians();
                tmpspd = 6.0f + random_float(2.5f);
                tmpspdX = cos(tmpdir) * tmpspd;
                tmpspdY = sin(tmpdir) * tmpspd;
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, tmpspdX, tmpspdY, player_flame, tmpdir, 0);
            }
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, portal_clear, 0, 0);
            play_sound_relative_to_player(snd_flame_cannon_end_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 11://ultra
            tmpdir = random_360_radians();
            for (int i = 0; i < 3; i++) {
                
                tmpspdX = cos(tmpdir) * 16;
                tmpspdY = sin(tmpdir) * 16;
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, explosion, 0, 2);
                tmpdir += 120 / degreestoradians;
            }
            play_sound_relative_to_player(snd_explosion_l_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 13://toxic
            create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, explosion, 0, 0);
            play_sound_relative_to_player(snd_explosion_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            for (int i = 0; i < 18; i++) {
                create_object(allObjects[object_index].position.x, allObjects[object_index].position.y, 0, 0, toxic_gas, 0.0f, 0);
            }
            play_sound_relative_to_player(snd_explosion_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 14://sticky
            ...
            for (int i = 0; i < 3; i++) {
                ...
                tmpspdX = cos(tmpdir) * 16;
                tmpspdY = sin(tmpdir) * 16;
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, explosion, 0, 0);
                tmpdir += 120 / degreestoradians;
            }
            play_sound_relative_to_player(snd_explosion_l_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            break;
        case 4://missile
            ...
            play_sound_relative_to_player(snd_explosion_l_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            for (int i = 0; i < 3; i++) {
                tmpspdX = random_float(16.0f) - 8.0f;
                tmpspdY = random_float(16.0f) - 8.0f;
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, explosion, 0, 1);
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, flame, 0, 0);
            }
            break;
        case 5://nuke
            play_sound_relative_to_player(snd_nuke_explode_ID, allObjects[object_index].position.x, allObjects[object_index].position.y);
            for (int i = 0; i < 8; i++) {
                tmpspdX = random_float(16.0f) - 8.0f;
                tmpspdY = random_float(16.0f) - 8.0f;
                create_object(allObjects[object_index].position.x + tmpspdX, allObjects[object_index].position.y + tmpspdY, 0, 0, explosion, 0, 0);
...
bool is_within_melee_slash(sf::Vector2f melee_pos, sf::Vector2f otherpos, int other_size, float melee_angle) {
    ...
    int main_hitbox = 25;   //default -> 24, feels a bit small because of perfect circle hitboxes, compared to orginal which uses precice pixel hitboxes
    int secondary_hitbox = 16;  //default -> 15
...
void enemy_die(int ENEMY, int PROJ) {
    ...
    case bandit:
        ...
        if (rand() % 20 == 0) {
            create_object(allObjects[ENEMY].position.x, allObjects[ENEMY].position.y, 0, 0, weapon_drop, 0, rand() % 110);
        }
        ...
        for (int h = -6; h < 7; h++) {
            for (int O : game_area[i + w][j + h].object_indexes) {
                    ...
                    case objectID::portal:
                        ...
                        break;
                    case objectID::rad:
                        if (abs(allObjects[O].position.x - allObjects[0].position.x) < 8 && abs(allObjects[O].position.y - allObjects[0].position.y) < 8 && player_alive) {
                    ...
                    case objectID::throne_2:
                        diffx = allObjects[O].position.x - allObjects[currOBJ].position.x;
                        diffy = allObjects[O].position.y - allObjects[currOBJ].position.y;
                        if (is_within_throne_2(allObjects[O].position, allObjects[currOBJ].position, player_hitbox)) {
                            tmpdir = atan2f(diffy, diffx) + 180.0f / degreestoradians;
...
void add_ammo_chest_to_player(int the_wep) {
                    ...
                    case nade:
                        if (allObjects[O].team != allObjects[currOBJ].team && is_within_circle(allObjects[currOBJ].position, allObjects[O].position, allObjects[currOBJ].my_hitbox + allObjects[O].my_hitbox)) {
                            ...
                            if (allObjects[O].alarm3 != 13 && allObjects[O].alarm3 != 14) {
                                ...
                                //stick to enemy
                                if (is_an_enemy(allObjects[currOBJ].my_id)) {
                                    allObjects[O].corpse_id = currOBJ;
                                    play_sound_relative_to_player(snd_nade_stick_ID, allObjects[O].position.x, allObjects[O].position.y);
                                }
                            }
                        }
                        break;
            ...
            for (int O : game_area[i + w][j + h].object_indexes) {
                if (O != currOBJ) {
                    ...
                    case objectID::idpd_freak:
                        ...
                        break;
                    case objectID::throne_2:
                        if (allObjects[O].alarm1 < 0 && is_within_throne_2(allObjects[O].position, allObjects[currOBJ].position, allObjects[currOBJ].my_hitbox)) {
    ...
    for (int w = -3; w < 4; w++) {
        for (int h = -3; h < 4; h++) {
            for (int O : game_area[i + w][j + h].object_indexes) {
                ...
                case throne_2:
                    impact_size_reduction = int(allObjects[currOBJ].image_index * 0.4f) * 8;
                    if (allObjects[O].alarm1 < 0 && allObjects[O].next_hurt < current_frame && is_within_throne_2(allObjects[O].position, allObjects[currOBJ].position, plasma_impact_hitbox)) {
                        plasma_impact_collision_2(currOBJ, O);
                    }
                    break;
                default:
            ...
            for (int O : game_area[i + w][j + h].object_indexes) {
                ...
                case nade:
                    if (is_within_melee_slash(allObjects[currOBJ].position, allObjects[O].position, allObjects[O].my_hitbox, allObjects[currOBJ].direction)) {
                        if (allObjects[O].alarm3 == 0 || allObjects[O].alarm3 == 2 || allObjects[O].alarm3 == 3 || (allObjects[O].alarm3 >= 11 && allObjects[O].alarm3 <= 14)) {
                        ...
                        else if (allObjects[O].alarm3 == 9 || allObjects[O].alarm3 == 7 && allObjects[O].team != player_team) {
                            allObjects[O].team = player_team;
                            allObjects[O].direction = allObjects[currOBJ].direction;
                            create_object(allObjects[O].position.x, allObjects[O].position.y, 0, 0, deflect, allObjects[currOBJ].direction * degreestoradians, 0);
                        }
            ...
            for (int O : game_area[i + w][j + h].object_indexes) {
                if (O != currOBJ) {
                    ...
                    case prop:
                        ...
                        break;
                    case plasma_huge:
                        if (allObjects[O].team != allObjects[currOBJ].team && is_within_circle(allObjects[O].position, allObjects[currOBJ].position, (allObjects[O].scale * plasma_hitbox + allObjects[currOBJ].my_hitbox))) {
...
void player_laser_collision(int currOBJ) {
    ...
    float x_spd = allObjects[currOBJ].speed.x;
    float y_spd = allObjects[currOBJ].speed.y;

    //line_of_sight
    while (!has_collided_with_wall) {
        prev_x_pos = x;
        prev_y_pos = y;
    ...
    if ((LMB_pressed && wep_reload <= 0.0f && ammo_type - cost * shots >= 0) || (skeleton_gamble && wep_reload <= 0.0f)) {
        ...
        for (int j = 0; j < shots + free_shots; j++) {
            ...
            if (wep == 16 || wep == 21) {    //gold plasma gun / gold laser pistol
                ...
                for (int I = -2; I < 3; I++) {
                    Xspd = cos(direction + inaccuracy + ((8.0f * I) / degreestoradians)) * proj_speed;
                    Yspd = sin(direction + inaccuracy + ((8.0f * I) / degreestoradians)) * proj_speed;
                    create_object(allObjects[0].position.x + Xspd / 2, allObjects[0].position.y + Yspd / 2, Xspd, Yspd, object_type, direction + inaccuracy + ((8.0f * I) / degreestoradians), 0);
                }
            }
            else if (wep == 24 || wep == 27) {   //lightning
                create_object(allObjects[0].position.x + Xspd / 2, allObjects[0].position.y + Yspd / 2, Xspd, Yspd, object_type, direction + inaccuracy, 14);
            }
            else if (wep == 25) {   //lightning rifle
                create_object(allObjects[0].position.x + Xspd / 2, allObjects[0].position.y + Yspd / 2, Xspd, Yspd, object_type, direction + inaccuracy, 25);
            }
            else if (wep == 26) {   //lightning shotgun
                for (int L = 0; L < 8; L++) {
                    inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                    create_object(allObjects[0].position.x + Xspd / 2, allObjects[0].position.y + Yspd / 2, Xspd, Yspd, object_type, direction + inaccuracy, 14);
                }
                ...
                if (wep >= energy_weps && wep < bullet_weps) {  //bullet wep
                    ...
                    if (wep == 36) {    //triple machinegun
                        ...
                        Yspd = sin(direction + inaccuracy + 15.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 15.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 15.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 15.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 15.0f / degreestoradians, bullet_type);
                    }
                    else if (wep == 40) {    //quadruple machinegun
                        Xspd = cos(direction + inaccuracy + 18.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 18.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 18.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 18.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 18.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 18.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy + 6.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 6.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 6.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 6.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 6.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 6.0f / degreestoradians, bullet_type);
                    }
                    else if (wep == 41) {    //double minigun
                        Xspd = cos(direction + inaccuracy + 4.25f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 4.25f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 4.25f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 4.25f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 4.25f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 4.25f / degreestoradians, bullet_type);
                    }
                    else if (wep == 42) {    //gold machinegun
                        Xspd = cos(direction + inaccuracy + 2.5f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 2.5f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 2.5f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 2.5f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 2.5f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 2.5f / degreestoradians, bullet_type);
                    }
                    else if (wep == 48) {    //bouncer shotgun
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                        Xspd = cos(direction + inaccuracy - 10.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 10.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 10.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy + 10.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 10.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 10.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 20.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 20.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 20.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy + 20.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 20.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 20.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 30.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 30.0f / degreestoradians) * proj_speed;
                        ...
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 14 + random_float(2), 0, object_type, direction + inaccuracy + extra_innacc, bullet_type);

                        extra_innacc = (random_float(7.0f) - 3.5f) / degreestoradians;
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 14 + random_float(2), 0, object_type, direction + inaccuracy + 9.0f / degreestoradians + extra_innacc, bullet_type);

                        extra_innacc = (random_float(7.0f) - 3.5f) / degreestoradians;
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 14 + random_float(2), 0, object_type, direction + inaccuracy - 9.0f / degreestoradians + extra_innacc, bullet_type);

                        extra_innacc = (random_float(7.0f) - 3.5f) / degreestoradians;
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 14 + random_float(2), 0, object_type, direction + inaccuracy + 18.0f / degreestoradians + extra_innacc, bullet_type);

                        extra_innacc = (random_float(7.0f) - 3.5f) / degreestoradians;
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 14 + random_float(2), 0, object_type, direction + inaccuracy - 18.0f / degreestoradians + extra_innacc, bullet_type);
                    }
                    else {
                        create_object(allObjects[0].position.x, allObjects[0].position.y, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                    }

                }
                else if (wep >= bullet_weps && wep < bolt_weps) {  //bolt wep
                    if (wep == 54) {
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                        Xspd = cos(direction + inaccuracy - 5.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 5.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 5.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy + 5.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 5.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 5.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy - 10.0f / degreestoradians) * proj_speed;
                        ...
                        Xspd = cos(direction + inaccuracy - 2.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy - 2.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy - 2.0f / degreestoradians, bullet_type);
                        Xspd = cos(direction + inaccuracy + 2.0f / degreestoradians) * proj_speed;
                        Yspd = sin(direction + inaccuracy + 2.0f / degreestoradians) * proj_speed;
                        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy + 2.0f / degreestoradians, bullet_type);
                    }
                        ...
                        for (int S = 0; S < 3; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = random_float(4.0f) + 20.0f;
                            Xspd = cos(direction + inaccuracy) * proj_speed;
                            Yspd = sin(direction + inaccuracy) * proj_speed;
                            create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                        }
                        ...
                        for (int S = 0; S < 4; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = random_float(8.0f) + 16.0f;
                            Xspd = cos(direction + inaccuracy) * proj_speed;
                            Yspd = sin(direction + inaccuracy) * proj_speed;
                            create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                        }
                        ...
                        create_object(allObjects[0].position.x, allObjects[0].position.y, Xspd, Yspd, player_bolt_burst, direction, bullet_type);
                    }
                    else if (wep == 62) {
                        for (int S = 0; S < 3; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                    ...
                    else if (wep == 64) {//seeker pistol
                        for (int S = 0; S < 2; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = 6.0f;
                            Xspd = cos(direction + inaccuracy) * proj_speed;
                            Yspd = sin(direction + inaccuracy) * proj_speed;
                            create_object(allObjects[0].position.x + cos(direction) * 12, allObjects[0].position.y + sin(direction) * 12, Xspd, Yspd, object_type, direction + inaccuracy, bullet_type);
                        }
                    }
                    else if (wep == 65) {//seeker shotgun
                        for (int S = 0; S < 6; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = 6.0f;
                            Xspd = cos(direction + inaccuracy) * proj_speed;
                    ...
                    case 68://eraser
                        inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                        for (int S = 0; S < 17; S++) {
                            proj_speed = 6.0f + random_float(6.0f) + float(S) / 3.0f;
                            create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        }
                        break;
                    case 69://wave gun
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 0, 0, object_type, direction + inaccuracy, 2);
                        break;
                    case 70://gold shotgun
                        for (int S = 0; S < 15; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = 11 + random_float(11);
                            create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        }
                        break;
                    ...
                    case 75://assault slugger
                        create_object(allObjects[0].position.x, allObjects[0].position.y, 0, 0, object_type, direction + inaccuracy, 1);
                        break;
                    ...
                    case 77://super slugger
                        for (int S = -2; S < 3; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation + (S * 10.0f / degreestoradians);
                            proj_speed = 18.0f;
                            create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        }
                        break;
                    case 78://golden slugger
                        inaccuracy = random_float(acc_variation * 2.0f) - acc_variation + (5.0f / degreestoradians);
                        proj_speed = 18.0f;
                        create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        inaccuracy = random_float(acc_variation * 2.0f) - acc_variation - (5.0f / degreestoradians);
                        proj_speed = 18.0f;
                    ...
                    case 81://flak cannon
                        inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                        proj_speed = 11.0f + random_float(2.0f);
                        create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        break;
                    case 82://super flak cannon
                        inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                        proj_speed = 10.0f + random_float(1.0f);
                        create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        break;
                    case 83://ultra shotgun
                        for (int S = 0; S < 9; S++) {
                            inaccuracy = random_float(acc_variation * 2.0f) - acc_variation;
                            proj_speed = 13.7f + random_float(6);
                            create_object(allObjects[0].position.x, allObjects[0].position.y, proj_speed, 0, object_type, direction + inaccuracy, bullet_type);
                        }
                        break;
                    }
...
void fire_weapon(int index, float direction, int shots = 1, int free_shots = 0, bool b_wep_shot = false, bool skeleton_gamble = false) {
    ...
    if (!crystal_is_shielding) {
        ...
        case 77://super slugger
            ...
            break;
        case 78://golden slugger
            fire_gun_shot(shots, skeleton_gamble, direction, gamble_reload, free_shots, 2, 20, 16.0f, player_shell, -0.0f, 8, 3.0f * accuracy_curr, false, player_shells, 2);
            break;
...
void object_tunnel_corner(int currOBJ) {
    ...
    case objectID::toxic_gas:
        ...
        break;
    case player_flame:
        allObjects[currOBJ].speed.x /= 3.0f;
        allObjects[currOBJ].speed.y /= 3.0f;
        bounce_in_corner_wall(currOBJ);
        break;
    ...
    case objectID::idpd_nade:
        if ((allObjects[currOBJ].alarm3 >= 4 && allObjects[currOBJ].alarm3 <= 9) || allObjects[currOBJ].alarm3 >= 15 || allObjects[currOBJ].alarm3 == 1) {
            destroy_projectile(currOBJ);
        }
        else {
            bounce_in_wall(currOBJ);
            allObjects[currOBJ].speeddir = allObjects[currOBJ].speeddir * 0.6;
            if (allObjects[currOBJ].alarm3 == 13 || allObjects[currOBJ].alarm3 == 14) {
                allObjects[currOBJ].speeddir = 0;
                play_sound_relative_to_player(snd_nade_stick_ID, allObjects[currOBJ].position.x, allObjects[currOBJ].position.y);
            }
            create_object(allObjects[currOBJ].position.x, allObjects[currOBJ].position.y, 0.5, 0.5, dust, 0, 0);    //dust
...
bool is_energy_slash_with_brain(int damage) {
    if (damage == 22 || damage == 14 || damage == 42) {
        if (laser_brain > 1.15f) {
            return true;
        }
    }
...
bool is_stickable(objectID obj_id) {
    switch (obj_id) {
    case bandit:__fallthrough;
    case idpd_freak:__fallthrough;
    case prop:__fallthrough;
    case throne_2:
        return true;
    default:
        return false;
...
void do_object_logic(int start, int end, sf::SoundBuffer all_sounds[], sf::Music& current_music) {    //logic done on each obect every frame
    float tmpdir = 0.0f;
    float tempSpeedX = 0.0f;
    float tempSpeedY = 0.0f;
    float tempSpeed = 0.0f;
    ...
    for (int i = start; i < end; i++) {
        ...
        case throne_2:
            ...
            //half hp noise
            max_hp = 600 * round(1 + float(LOOPS) / 3) * (1 + (LOOPS * 0.05f)) * scarier_face;
        ...
        case rad:
            ...
            if (allObjects[i].next_hurt > current_frame) {
                ...
                if (game_area[int((allObjects[i].position.x + allObjects[i].speed.x) / 16.0f)][int((allObjects[i].position.y + allObjects[i].speed.y) / 16.0f)].my_grid_type != wall) {
                    allObjects[i].position += allObjects[i].speed;
                }
            }
                ...
                float tempSpdx = cos(tmpdir) * 12.0f;
                float tempSpdy = sin(tmpdir) * 12.0f;

                //previous position
                //allObjects[i].speed = allObjects[O].position;

                //corner starving isnt possible with this rad logic so maybe make enemies drop less rads, or lower rad attraction radius to make rad management harder

                //potential step

                if (game_area[int((allObjects[i].position.x + tempSpdx) / 16.0f)][int((allObjects[i].position.y + tempSpdy) / 16.0f)].my_grid_type == wall || 

                    (game_area[int((allObjects[i].position.x + tempSpdx) / 16.0f)][int((allObjects[i].position.y) / 16.0f)].my_grid_type == wall) && game_area[int((allObjects[i].position.x) / 16.0f)][int((allObjects[i].position.y + tempSpdy) / 16.0f)].my_grid_type == wall
            ...
            /*if (allObjects[i].next_hurt == current_frame || (!player_alive && allObjects[i].next_hurt < current_frame)) {
            ...
            diffx = allObjects[i].position.x - allObjects[0].position.x;
            diffy = allObjects[i].position.y - allObjects[0].position.y;
            if (player_alive && allObjects[i].next_hurt < current_frame && (sqrt(pow(diffx, 2) + pow(diffy, 2)) < plutonium_hunger || created_portal)) {
        ...
        case player_bolt_stick:
            if (allObjects[i].alarm3 != 0) {   //stuck to enemy
                ...
                if (allObjects[i].image_index > 30) {
                    allObjects[i].my_id = nothing;
                }
            }
            allObjects[i].image_index++;
        ...
        case player_shell:
            ...
            allObjects[i].growspeed += allObjects[i].speeddir / 10.0f;

            allObjects[i].speeddir -= allObjects[i].friction;

            if (allObjects[i].speeddir < 0.0f || allObjects[i].image_index > 14) {
                if(allObjects[i].size == 5 || allObjects[i].size == 6){
                    destroy_projectile(i);
                }
                else {
                    allObjects[i].my_id = nothing;
        ...
        case idpd_nade:
            ...
            if (allObjects[i].alarm2 >= 10 && (allObjects[i].alarm3 == 0 || allObjects[i].alarm3 == 2 || allObjects[i].alarm3 == 3 || allObjects[i].alarm3 == 11 || allObjects[i].alarm3 == 12 || allObjects[i].alarm3 == 13 || allObjects[i].alarm3 == 14 || allObjects[i].my_id == idpd_nade)) {
                allObjects[i].friction = 0.4f;
                if (allObjects[i].my_id == idpd_nade) {
        ...
        case debris:
            ...
            if (allObjects[i].alarm1 < 1) {
                create_object(allObjects[i].position.x, allObjects[i].position.y, 0.5, 0.5, dust, 0, 0);    //dust
                allObjects[i].my_id = nothing;
            }
            if (allObjects[i].alarm2 < 1) {
                create_object(allObjects[i].position.x, allObjects[i].position.y, 0.5, 0.5, dust, 0, 0);    //dust
                allObjects[i].alarm2 = round(((rand() % 20) / allObjects[i].speeddir) + 1);
            }
...
void player_bolt_burst_step(int obj) {
    play_sound_on_player(snd_super_splinter_ID);
    for (int S = 0; S < 2; S++) {
        float inaccuracy = (random_float(10.0f * 2.0f) - 10.0f) / degreestoradians;
        float proj_speed = random_float(4.0f) + 20.0f;
        float Xspd = cos(direction_to_mouse + inaccuracy) * proj_speed;
        float Yspd = sin(direction_to_mouse + inaccuracy) * proj_speed;
        create_object(allObjects[0].position.x + Xspd / 8, allObjects[0].position.y + Yspd / 8, Xspd, Yspd, player_bolt, direction_to_mouse + inaccuracy, 3);
    }
    allObjects[obj].size--;
    if (allObjects[obj].size <= 0) {
        allObjects[obj].my_id = nothing;
    }
}

void player_bullet_burst_step(int obj) {
    float inaccuracy = 0.0f;
    float inaccuracy_x = 0.0f;
    float inaccuracy_y = 0.0f;
    if (allObjects[obj].image_index % allObjects[obj].alarm1 == 0) {
        if (allObjects[obj].alarm2 != 2) {
            int IIDX = 0;
            if (allObjects[obj].damage == 3) {
                IIDX = 0;   //normal
            }
            else {
                IIDX = 3;   //heavy
            ...
            if (allObjects[obj].damage == 3) {
                if (allObjects[obj].alarm2 == 0) {
                    ...
                    play_sound_on_player(snd_gold_machinegun_ID);
                    inaccuracy = random_float(2.0f) - 1.0f;
                }
            }
            else {
            ...
            inaccuracy_y = sin(direction_to_mouse + inaccuracy) * 16.0f;
            create_object(allObjects[0].position.x + inaccuracy_x / 4, allObjects[0].position.y + inaccuracy_y / 4, inaccuracy_x, inaccuracy_y, player_bullet, direction_to_mouse + inaccuracy, IIDX);
            if (wep == 33 || wep == 38 || wep == 43 || wep == 46) {
                wep_kick = 4;
            }
        }
        else {  //rogue burst
            allObjects[obj].size--;
            play_sound_on_player(snd_rogue_rifle_ID);
            inaccuracy = random_float(10.0f) - 5.0f;
            inaccuracy /= degreestoradians;
            inaccuracy_x = cos(direction_to_mouse + inaccuracy) * 16.0f;
            inaccuracy_y = sin(direction_to_mouse + inaccuracy) * 16.0f;
            create_object(allObjects[0].position.x + inaccuracy_x / 4, allObjects[0].position.y + inaccuracy_y / 4, inaccuracy_x, inaccuracy_y, rogue_bullet, direction_to_mouse + inaccuracy, 0);
            if (wep == 31) {
                wep_kick = 4;
            }
        }
    ...
    if ((allObjects[obj].image_index % allObjects[obj].alarm2) == 0) {
        if (allObjects[obj].damage == 3) {//nade rifle
            ...
            for (int i = 0; i < 2; i++) {
                ...
                float tmp_spd = 6.0f + random_float(2.0f);
...
void player_shell_burst_step(int obj) {
    ...
    float inaccuracy_y = 0.0f;
    if (allObjects[obj].image_index % allObjects[obj].alarm1 == 0) {
        if (allObjects[obj].damage == 3) {//wave

            allObjects[obj].size--;
            play_sound_on_player(snd_wave_gun_ID);
            inaccuracy = sin((float)allObjects[obj].size / 4.0f) * 20;
            inaccuracy /= degreestoradians;

            create_object(allObjects[0].position.x, allObjects[0].position.y, 16.0f, 0, player_shell, direction_to_mouse + inaccuracy, 0);
...
void player_bolt_step(int obj) {

    if (allObjects[obj].alarm3 == 1) {
        allObjects[obj].my_id = nothing;
        return;
    }
    ...
    if (allObjects[obj].damage == 9) {  //seeker
        int closest_enemy = 0;
        sf::Vector2f in_front_of;

        float tmpdir = atan2f(allObjects[obj].speed.y, allObjects[obj].speed.x);
        in_front_of.x = cos(tmpdir) * 48;
        in_front_of.y = sin(tmpdir) * 48;
        closest_enemy = find_nearest_LOS_enemy(allObjects[obj].position + in_front_of);

        if (closest_enemy != 0) {
            allObjects[obj].speeddir = 6.0f;
            allObjects[obj].direction /= degreestoradians;
            tmpdir = atan2f(allObjects[closest_enemy].position.y - allObjects[obj].position.y, allObjects[closest_enemy].position.x - allObjects[obj].position.x);
            motion_add_dir(tmpdir, 0.54f, obj);
            if (is_within_circle(allObjects[obj].position, allObjects[closest_enemy].position, 48 * (1 + bolt_marrow))) {
                motion_add_dir(tmpdir, 4.0f, obj);
            }

            allObjects[obj].speed.x = cos(allObjects[obj].direction) * 6.0f;
            allObjects[obj].speed.y = sin(allObjects[obj].direction) * 6.0f;
    ...
    for (int i = 0; i < 16; i++) {
        ...
        allObjects[obj].position.x += allObjects[obj].speed.x / 16;
        allObjects[obj].position.y += allObjects[obj].speed.y / 16;
        ...
        if (int(X_prev / 16) != int(X_ / 16) && int(Y_prev / 16) != int(Y_ / 16) && //moved diagonal
            ...
            if (allObjects[obj].damage != 45) {
                ...
                if (allObjects[obj].alarm2 > 0) {   //dig
                    allObjects[obj].alarm2--;
                    //only destroy closest
                    float dist_X_prev = ((float(int(X_prev / 16) * 16 + 8)) - X_);
                    float dist_Y_prev = ((float(int(Y_prev / 16) * 16 + 8)) - Y_);
                    float dist_X = ((float(int(X_ / 16) * 16 + 8)) - X_);
                    float dist_Y = ((float(int(X_ / 16) * 16 + 8)) - X_);
                    if (sqrt(dist_X_prev * dist_X_prev + dist_Y * dist_Y) < sqrt(dist_Y_prev * dist_Y_prev + dist_X * dist_X)) {
                        create_explo_tile(int(X_prev / 16), int(Y_ / 16));
                    }
                    else {
                        create_explo_tile(int(X_ / 16), int(Y_prev / 16));
                    }
                }
                else {
                    destroy_projectile(obj);
        ...
        if (game_area[int(X_ / 16)][int(Y_ / 16)].my_grid_type == wall) {
            if (allObjects[obj].damage != 45) {
                ...
                if (allObjects[obj].alarm2 > 0) {   //dig
                    allObjects[obj].alarm2--;
                    create_explo_tile(int(X_ / 16), int(Y_ / 16));
                }
                else {
                    destroy_projectile(obj);
                    create_object(allObjects[obj].position.x, allObjects[obj].position.y, 0.0f, 0, player_bolt_stick, allObjects[obj].direction, allObjects[obj].damage);
        ...
        if (allObjects[obj].my_id != nothing) {
            ...
            case 45:
                pierce_threashold = 20;
                break;
            case 20:
                pierce_threashold = 10;
                break;
            case 21:
                pierce_threashold = 17;
                break;
            case 50:
                pierce_threashold = 30;
                break;
            case 4:
                pierce_threashold = 3;
                break;
    ...
    if (allObjects[obj].image_index > 1) {
        if (allObjects[obj].damage == 45) {//ultra
            create_object(allObjects[obj].position.x - allObjects[obj].speed.x / 2, allObjects[obj].position.y - allObjects[obj].speed.y / 2, 24, 0, bolt_trail, (allObjects[obj].direction - 180) / degreestoradians, 2);
        }
        else if (allObjects[obj].damage > 10) { //normal
            create_object(allObjects[obj].position.x - allObjects[obj].speed.x / 2, allObjects[obj].position.y - allObjects[obj].speed.y / 2, 24, 0, bolt_trail, (allObjects[obj].direction - 180) / degreestoradians, 0);
        }
        else if (allObjects[obj].damage == 9) { //seeker
            create_object(allObjects[obj].position.x - allObjects[obj].speed.x / 2, allObjects[obj].position.y - allObjects[obj].speed.y / 2, 6, 0, bolt_trail, (allObjects[obj].direction - 180) / degreestoradians, 0);
        }
        else {//splinter
            create_object(allObjects[obj].position.x - allObjects[obj].speed.x / 2, allObjects[obj].position.y - allObjects[obj].speed.y / 2, 24, 0, bolt_trail, (allObjects[obj].direction - 180) / degreestoradians, 1);
        }
    }
}
...
void player_bullet_double_step(int obj) {
    float X_ = 0;
    float Y_ = 0;
    ...
    else if (int(X_prev / 16) != int(X_ / 16) && int(Y_prev / 16) != int(Y_ / 16) && //moved diagonal
             game_area[int(X_prev / 16)][int(Y_ / 16)].my_grid_type == wall && 
             game_area[int(X_ / 16)][int(Y_prev / 16)].my_grid_type == wall) {//tunneled diagonally
        destroy_projectile(obj);
        return;
...
void idpd_freak_step(int i) {
    //do this in collision so bullets cant step instantly when spawning
    float tmpdir;
    float tempSpeed;
    float tempSpeedX;
    float tempSpeedY;
...
void nade_step(int i) {     //NOW
    ...
    //flare
    if (allObjects[i].alarm3 == 8) {
        float inaccuracy = random_360_radians();


        float tmp_spd = 1.0f + random_float(3.0f);

        float inaccuracy_x = cos(direction_to_mouse + inaccuracy) * tmp_spd;
        float inaccuracy_y = sin(direction_to_mouse + inaccuracy) * tmp_spd;

        //player_flame
        create_object(allObjects[i].position.x, allObjects[i].position.y, inaccuracy_x, inaccuracy_y, player_flame, inaccuracy, 0);
    }
    //flame ball
    if (allObjects[i].alarm3 == 9) {
        ...
        //player_flame
        for (int b = 0; b < 5; b++) {
            inaccuracy = allObjects[i].alarm1 / 16.0f + (b * 72.0f / degreestoradians) + allObjects[i].gun_angle;


            tmp_spd = 3.0f + random_float(1.0f);
    ...
    if (allObjects[i].alarm3 == 7) {
        ...
        create_object(allObjects[i].position.x + tmpspdX, allObjects[i].position.y + tmpspdY, 0, 0, meat_explosion, 0, player_team);
        create_object(allObjects[i].position.x, allObjects[i].position.y, tmpspdX / 10, tmpspdY / 10, static_effect, tmpdir * degreestoradians, 216);
    }

    switch (allObjects[i].alarm3) {
    case 0:case 1:case 2:case 3:case 6:case 7:case 8:case 9:case 11:case 12:case 13:case 14:
        if (allObjects[i].alarm1 > 90) {
            destroy_projectile(i);
        }
        break;
                ...
                for (int w = -1; w < 2; w++) {      //each wall checks around it for possible collisions with objects that are supposed to be bigger than a single point
                    for (int h = -1; h < 2; h++) {
                        for (int O : game_area[i + w][j + h].object_indexes) {      //walls collisions and bounce
                            ...
                            case player_bullet:
                                if (w == 0 && h == 0) {
                                    if (allObjects[O].damage == 18) { //ultra bullet
                                        player_bullet_double_step(O);
                                    }
                                }
                                break;
                            case player_bullet_burst:
                            ...
                            case player_bolt_burst:
                                if (w == 0 && h == 0) {
                                    player_bolt_burst_step(O);
                                }
                                break;
                            case player_shell_hyper:
                                if (w == 0 && h == 0) {
                                    player_shell_hyper_create(O);
                                    allObjects[O].my_id = nothing;
                                }
                                break;
                            case player_lightning_spawn:
                                if (w == 0 && h == 0) {
                                    player_lightning_create(allObjects[O].position, allObjects[O].direction, allObjects[O].size);
                                }
                                break;
                            case player_laser_burst:
                                if (w == 0 && h == 0) {
            ...
            case wall:
                for (int w = -1; w < 2; w++) {      //each wall checks around it for possible collisions with objects that are supposed to be bigger than a single point
                    for (int h = -1; h < 2; h++) {
                        for (int O : game_area[i + w][j + h].object_indexes) {      //walls collisions and bounce
                            switch (allObjects[O].my_id) {
                            case objectID::rad:
                                /*if (allObjects[O].team == 0) {
                                    allObjects[O].team = 1;
                                    tmpdir = direction_to_player(O);
                                    tempSpdx = cos(tmpdir) * 12.0f;
                                    tempSpdy = sin(tmpdir) * 12.0f;

                                    //previous position
                                    allObjects[O].speed = allObjects[O].position;

                                    //potential step
                                    diffx = (allObjects[O].position.x + tempSpdx) - ((i * 16) + 8);    //distance from the center of the wall
                                    diffy = (allObjects[O].position.y + tempSpdy) - ((j * 16) + 8);    //distance from the center of the wall
                                    ...
                                    if (game_area[int((allObjects[O].position.x + tempSpdx) / 16.0f)][int((allObjects[O].position.y + tempSpdy) / 16.0f)].my_grid_type == wall) {
                                        if (tempSpdx > tempSpdy) {

                                            if (game_area[int((allObjects[O].position.x + tempSpdx) / 16.0f)][int((allObjects[O].position.y) / 16.0f)].my_grid_type == wall) {
                                                if (tempSpdy > 6.0f && game_area[int((allObjects[O].position.x) / 16.0f)][int((allObjects[O].position.y + tempSpdy) / 16.0f)].my_grid_type != wall) {
                                                    allObjects[O].position = allObjects[O].position + sf::Vector2f{ 0.0f, tempSpdy };
                                                }
                                            }
                                        }
                                        else {
                                            if (game_area[int((allObjects[O].position.x) / 16.0f)][int((allObjects[O].position.y + tempSpdy) / 16.0f)].my_grid_type == wall) {
                                                if (tempSpdx > 6.0f && game_area[int((allObjects[O].position.x + tempSpdx) / 16.0f)][int((allObjects[O].position.y) / 16.0f)].my_grid_type != wall) {
                                                    allObjects[O].position = allObjects[O].position + sf::Vector2f{ tempSpdx, 0.0f };
                                                }
                                            }
                                        }
                                    }
                ...
                for (int currOBJ : game_area[i][j].object_indexes) {    //inside of wall
                    ...
                    case player_shell_burst:
                        ...
                        break;
                    case player_shell_hyper:
                        player_shell_hyper_create(currOBJ);
                        allObjects[currOBJ].my_id = nothing;
                        break;
                    case player_lightning_spawn:
                        player_lightning_create(allObjects[currOBJ].position, allObjects[currOBJ].direction, allObjects[currOBJ].size);
                        break;
                    case objectID::plant_tangle_seed:
                        destroy_projectile(currOBJ);
                ...
                for (int currOBJ : game_area[i][j].object_indexes) {
                    ...
                    case player_bullet:
                        if (allObjects[currOBJ].damage == 18) { //ultra bullet
                            player_bullet_double_step(currOBJ);
                        }
                        break;
                    case player_bolt_burst:
                        player_bolt_burst_step(currOBJ);
...
void generate_level(sf::SoundBuffer all_sounds[], sf::Music& current_music) {
    ...
    allFloors[gen_curr_floor_index].setOrigin(0, 0);
    gen_curr_floor_index++;
...
void poll_movement_inputs(int& poll_move_up, int& poll_move_down, int& poll_move_left, int& poll_move_right, int &poll_move_total) {
    ...
    polling_window.setFramerateLimit(240);
...
int main(int argc, char* argv[])
{
    ...
    add_new_sound(snd_explosion_l_ID, "snd/explosion_l.wav", all_sounds, all_sounds_mirror, 0.1f, 0.003f);
    ...
    add_new_sound(snd_nade_stick_ID, "snd/nade_stick.wav", all_sounds, all_sounds_mirror, 0.05f, 0.01f);
    ...
    debug_timer_startup.timing_us_end();
    ...
    //load sprites
        ...
        sf::Sprite wep_arrow_sprite(wep_arrow_tex);
        wep_arrow_sprite.setOrigin(4, 4);
    ...
    while (window.isOpen()){
        ...
        if (global_debug) {
            for (int i = 0; i < max_objects; i++) {
                ...
                if (is_an_enemy(allObjects[i].my_id)) {
                    curr_enemycount_real++;
                    DEBUG_ENEMY_TELEPORT_TO = i;
                }
            }
        }

        sf::Text tO;
        tO.setString("curr_objcount_real: " + std::to_string(curr_objcount_real));
        ...
        if (!GAME_PAUSED) {
            ...
            if (player_alive) {
                ...
                if ((PRECISE_MOVEMENT && player_character != frog) || horizontal_player_move || vertical_player_move || roll > 0 || (player_character == frog && !player_held_RMB)) {
                    ...
                    float spd_add_x = cos(dirto_add) * player_acceleration;
                    float spd_add_y = sin(dirto_add) * player_acceleration;
        ...
        if (t2_draw_in_front == true) {
            ...
            if (allObjects[T2_object_index].my_id == throne_2) {
                if (allObjects[T2_object_index].image_index >= 0) {
                    T2_sprite.setTexture(throne2Idle);
                    choice = int(allObjects[T2_object_index].image_index * 0.4f) % 8;
                }
                else {
                    T2_sprite.setTexture(throne2Hurt);
                    if (allObjects[T2_object_index].image_index < -3) {
                        choice = 0;
                    }
                    else if (allObjects[T2_object_index].image_index < -1) {
                        choice = 1;
                    }
                    else {
                        choice = 2;
                ...
                for (int idx : game_area[i][j].object_indexes) {
                    ...
                    case melee_slash:
                        ...
                        if (choice == 0) {
                            ...
                            case 12:
                                ...
                                break;
                            case 16:__fallthrough;
                            case 24:__fallthrough;
                            case 26:
                    ...
                    case rebel_ally:
                        ...
                        if (allObjects[idx].image_index >= 0) {
                            ...
                            else if (allObjects[idx].image_index < -1) {
                                choice = 1;
                            }
                            else {
                                choice = 2;
                    ...
                    case idpd_freak:
                        ...
                        //keep within -180 and 180 degrees
                        tmp_wep_angle = allObjects[idx].gun_angle;
                        if (tmp_wep_angle > 180.0f / degreestoradians) {
                            tmp_wep_angle -= 360.0f / degreestoradians;
                        }
                        if (tmp_wep_angle < -180.0f / degreestoradians) {
                            tmp_wep_angle += 360.0f / degreestoradians;
                        }
                        ...
                        if (tmp_wep_angle <= 0) {
                            sf::Vector2f gun_offset = { cos(tmp_wep_angle) * 3, sin(tmp_wep_angle) * 3 };
                            ...
                            rotateable_sprites_guns[rotateableSpriteGunIndex].setOrigin({ 16,16 });
                            rotateable_sprites_guns[rotateableSpriteGunIndex].setRotation(tmp_wep_angle * degreestoradians);
                            if (abs(tmp_wep_angle) > (90.0f / degreestoradians)) {
                                rotateable_sprites_guns[rotateableSpriteGunIndex].setScale(1, -1);
                            }
                            else {
                                rotateable_sprites_guns[rotateableSpriteGunIndex].setScale(1, 1);
                            ...
                            rotateable_sprites_guns_top[rotateableSpriteGunTopIndex].setRotation(tmp_wep_angle * degreestoradians);
                            if (abs(tmp_wep_angle) > (90.0f / degreestoradians)) {
                    ...
                    case player_lightning:
                        ...
                        variable_textures_bloom[variableTexturesBloomIndex].setPosition(allObjects[idx].position - cameraPos);
                        variable_textures_bloom[variableTexturesBloomIndex].setRotation(allObjects[idx].direction * degreestoradians);
                        variable_textures_bloom[variableTexturesBloomIndex].setTextureRect(sf::IntRect{ choice, 0, 1, 1 });
                    ...
                    case player_lightning_orb:
                        ...
                        variable_textures_bloom[variableTexturesBloomIndex].setTexture(player_lightning_ball_tex);
                        variable_textures_bloom[variableTexturesBloomIndex].setColor({ 255, 255, 255, 255 });
                        variable_textures_bloom[variableTexturesBloomIndex].setPosition(allObjects[idx].position - cameraPos);
                        variable_textures_bloom[variableTexturesBloomIndex].setRotation(0);
                        variable_textures_bloom[variableTexturesBloomIndex].setTextureRect(sf::IntRect{ choice * 32, 0, 32, 32 });
                        variable_textures_bloom[variableTexturesBloomIndex].setOrigin(16, 16);
                        variable_textures_bloom[variableTexturesBloomIndex].setScale(1, 1);
                        variableTexturesBloomIndex++;
                        break;
                    ...
                    case player_bolt_stick:
                            ...
                            else if (allObjects[idx].damage == 50) {
                                choice = 32;
                            }
                            else if (allObjects[idx].damage == 45) {
                                choice = 64;
                            }
                            else if (allObjects[idx].damage == 4) {
                                choice = 80;
                            }
                            else if (allObjects[idx].damage == 16) {
                                choice = 48;
                            }
                            else if (allObjects[idx].damage == 21) {
                                choice = 16;
                            }
                            else if (allObjects[idx].damage == 9) {
                                choice = 96;
                            }

                            if (allObjects[idx].image_index < 2) {
                                choice2 = 0;
                            }
                            else {
                                choice2 = 16;
                    ...
                    case player_shell:
                        if (allObjects[idx].image_index < 2 || allObjects[idx].size == 5 || allObjects[idx].size == 6) {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                if (int(allObjects[idx].growspeed) % 2) { rotateable_sprites_bullets[rotateableSpriteBulletIndex].setTexture(player_super_flak_shell_0); }
        ...
        debug_timer_fps.timing_us_end();
        debug_timer_fps.timing_us_start();

        if (fps_samples_idx > 29) {
            fps_samples_idx = 0;
        }

        fps_samples[fps_samples_idx] = 1.0f / ((float)debug_timer_fps.time_elapsed / 1000000.0f);
        ...
        for (int idx = 0; idx < 30; idx++) {
            average_fps += fps_samples[idx];
        }
        average_fps /= 30.0f;
        
        tC.setString("fps: " + std::to_string(average_fps));
        ...
        tspr.setString("debug_timer_startup: " + std::to_string(float(debug_timer_startup.time_elapsed) / 1000) + " ms");
